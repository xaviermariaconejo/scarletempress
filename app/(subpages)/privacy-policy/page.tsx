  ...
  return (
    <main className={clsx('container mx-auto p-8 md:py-20', animationFadeUp)}>
      ...
      <section className="mb-8">
        ...
        <p className="mb-8">
          Respetando lo establecido en la legislación vigente, Scarlet Empress
        ...
        <article className="mb-8">
          ...
          <p>
            ...
            Scarlet Empress es: Marta Alcaide Lorca, con NIF: 50344756-X (en
            adelante, Responsable del tratamiento). Sus datos de contacto son
            los siguientes:
          </p>
          <ul className="ml-8 mt-2 list-disc">
        ...
        <article className="mb-8">
          ...
          <p>
            ...
            informamos que los datos personales recabados por Scarlet Empress,
            ...
            Scarlet Empress y el Usuario o el mantenimiento de la relación que
            se establezca en los formularios que este rellene, o para atender
            una solicitud o consulta del mismo. Asimismo, de conformidad con lo
            previsto en el RGPD y la LOPD-GDD, salvo que sea de aplicación la
            excepción prevista en el artículo 30.5 del RGPD, se mantiene un
            registro de actividades de tratamiento que especifica, según sus
            finalidades, las actividades de tratamiento llevadas a cabo y las
        ...
        <article className="mb-8">
          ...
          <p>
            Las categorías de datos que se tratan en Scarlet Empress son
            únicamente datos identificativos. En ningún caso, se tratan
            categorías especiales de datos personales en el sentido del artículo
            9 del RGPD.
          </p>
        </article>
        ...
        <article className="mb-8">
          ...
          <p>
            ...
            consentimiento. Scarlet Empress se compromete a recabar el
        ...
        <article className="mb-8">
          ...
          <p>
            Los datos personales son recabados y gestionados por Scarlet Empress
            con la finalidad de poder facilitar, agilizar y cumplir los
          ...
          <p className="mt-4">
            ...
            propias del objeto social de Scarlet Empress, así como para la
            extracción, almacenamiento de datos y estudios de marketing para
            adecuar el Contenido ofertado al Usuario, así como mejorar la
        ...
        <article className="mb-8">
          ...
          <p>
            ...
            datos personales de forma lícita por Scarlet Empress. Si se trata de
            un menor de 14 años, será necesario el consentimiento de los padres
            o tutores para el tratamiento, y este solo se considerará lícito en
            la medida en la que los mismos lo hayan autorizado.
          </p>
        </article>
        ...
        <article className="mb-8">
          ...
          <p>
            Scarlet Empress se compromete a adoptar las medidas técnicas y
          ...
          <p className="mt-4">
            Sin embargo, debido a que Scarlet Empress no puede garantizar la
            inexpugnabilidad de internet ni la ausencia total de hackers u otros
            que accedan de modo fraudulento a los datos personales, el
            Responsable del tratamiento se compromete a comunicar al Usuario sin
            dilación indebida cuando ocurra una violación de la seguridad de los
            datos personales que sea probable que entrañe un alto riesgo para
            los derechos y libertades de las personas físicas. Siguiendo lo
            establecido en el artículo 4 del RGPD, se entiende por violación de
            la seguridad de los datos personales toda violación de la seguridad
            que ocasione la destrucción, pérdida o alteración accidental o
            ilícita de datos personales transmitidos, conservados o tratados de
            otra forma, o la comunicación o acceso no autorizados a dichos
            datos.
          </p>
          <p className="mt-4">
        ...
        <article className="mb-8">
          ...
          <ul className="ml-8 mt-2 list-disc">
            <li>
              ...
              confirmación de si Scarlet Empress está tratando o no sus datos
              personales y, en caso afirmativo, obtener información sobre sus
              datos concretos de carácter personal y del tratamiento que Scarlet
              Empress haya realizado o realice, así como, entre otra, de la
            ...
            <li>
              ...
              el tratamiento de los mismos por parte de Scarlet Empress.
            </li>
            <li>
        ...
        <article className="mb-8">
          ...
          <p>
            ...
            acceder a páginas web de terceros distintos de Scarlet Empress, y
            que por tanto no son operados por Scarlet Empress. Los titulares de
            dichos sitios web dispondrán de sus propias políticas de protección
            de datos, siendo ellos mismos, en cada caso, responsables de sus
            propios ficheros y de sus propias prácticas de privacidad.
          </p>
        </article>
      ...
      <section>
        ...
        <p className="mt-4">
          Scarlet Empress se reserva el derecho a modificar su Política de
        ...
        <p className="mt-4">
          ...
          web gratis online el día 28/03/2024.
        </p>
      </section>
    </main>
  );
