...
export function Services() {
  return (
    <section
      className={`justify-stat container flex w-full flex-col items-center px-4 py-16`}
    >
      <h2 className={clsx('mb-8 text-3xl font-semibold', animationFadeUp)}>
        Hago que tus ideas tomen forma
      </h2>
      <p
        className={clsx('text-l mb-14 w-[620px] text-center', animationFadeUp)}
      >
